 ...
 */
angular.module ('starter.awardedOrderCtrl', [])

    .controller ('awardedOrderCtrl', function ($scope, $state, $rootScope, $stateParams, $util, $allOrdersdService, $allOrdersFactory, $errorPopupFactory, $timeout) {
        $rootScope.nowModule = {index : 3, listIndex : 7};
                    ...
                    .then (function (response) {
                        ...
                        if (response.error === '0' ) {
                            if(response.data.length !== 0){
                                ...
                                console.log('vm.orderEach',response.data);
