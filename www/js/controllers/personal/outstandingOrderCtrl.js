 ...
 */
angular.module ('starter.outstandingOrderCtrl', [])

    .controller ('outstandingOrderCtrl', function ($scope, $state, $rootScope, $util, $allOrdersdService, $stateParams, $allOrdersFactory, $errorPopupFactory, $timeout) {
        $rootScope.nowModule = {index : 3,  listIndex: 5 };
