...
angular.module('starter.superLottoCtrl', [])
    ...
    .controller('superLottoCtrl', function ($scope, $state, $ionicModal, getWareIssueService, $ionicLoading, $http, $rootScope, $util, $interval, BettingService, $errorPopupFactory, $getActivityData, $stateParams) {
